    ...
    <div className="min-h-screen bg-background pb-28">
      ...
      <main className="mx-auto max-w-md space-y-5 px-6 animate-fade-up">
        ...
        <div className="card-bloom relative overflow-hidden border-l-4 border-primary p-6">
          ...
          <Link to={`/workout/${"squat"}`} className="btn-primary mt-4 inline-flex hover:opacity-95">
            Start Workout →
          </Link>
        </div>
...
function QuickAction({ to, params, icon, label }: { to: any; params?: any; icon: React.ReactNode; label: string }) {
  return (
    <Link to={to} className="flex shrink-0 items-center gap-2 rounded-full bg-white px-4 py-2.5 text-sm font-semibold text-primary-dark shadow-bloom hover:bg-primary-tint">
