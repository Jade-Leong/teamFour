...
// faq.js
//
// Curated, medically-grounded Q&A for the between-sets voice assistant. Answers
// are short (they get spoken aloud via TTS) and stay within prenatal-squat form
// guidance (ACOG / Healthline). Anything outside scope falls back to a safe
// "ask your provider" answer — we never improvise medical advice.
//
// matchFaq(transcript) scores each entry by how many of its keywords appear in
// the user's (lowercased) transcript and returns the best answer, or the
...
// Returns { answer, id } for the best-matching FAQ entry, or the fallback.
export function matchFaq(transcript) {
